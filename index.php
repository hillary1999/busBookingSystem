    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                   This is a company that deals with travels mostly by the use of bus. Over the years, we have hash_had
                   a huge increase in the nuber of customers therefore we decided to come up with an online system where
                   a customer can simply share their details online.
                   This a company that has diligent customer cares, we work to always improve on something. I therefore
                   dont see why a customer like you wont consider this kind of sevice. welcome all
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - The Bus Ticket Booking System | Made with &#10084;&#65039; by Hillary Oketch
                        </p>
        </footer>
    </div>
